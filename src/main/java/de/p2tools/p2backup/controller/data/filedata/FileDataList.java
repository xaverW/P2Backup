...
public class FileDataList extends SimpleListProperty<FileData> {
    private FilteredList<FileData> filteredList = null;
    private SortedList<FileData> sortedList = null;

    public FileDataList() {
        super(FXCollections.observableArrayList());
    }

    public FilteredList<FileData> getFilteredList() {
    ...
    public SortedList<FileData> getSortedList() {
        if (sortedList == null) {
