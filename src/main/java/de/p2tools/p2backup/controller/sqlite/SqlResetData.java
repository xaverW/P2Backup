...
public class SqlResetData {
    ...
    public static boolean getResetData(BackupInfo backupInfo, BackupData backupData, ResetDataList resetDataList) {
        ...
        try (var conn = DriverManager.getConnection(url);
            ...
            while (rs.next()) {
                ...
                resetDataList.add(new ResetData(fileData, backupData));
            }
