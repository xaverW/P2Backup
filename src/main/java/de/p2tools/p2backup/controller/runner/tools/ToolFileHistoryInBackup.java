...
import de.p2tools.p2backup.gui.tools.DialogFileHistory;
...
public class ToolFileHistoryInBackup {
    ...
    private final DialogFileHistory dialogFileHistory;


    public ToolFileHistoryInBackup(DialogFileHistory dialogFileHistory,
                                   BackupInfo backupInfo, AtomicBoolean atomicBoolean) {
        this.progData = ProgData.getInstance();
        this.dialogFileHistory = dialogFileHistory;
    ...
    private void work() {
        ...
        dialogFileHistory.setResult(fileListData);
