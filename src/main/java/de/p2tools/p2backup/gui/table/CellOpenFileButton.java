...
public class CellOpenFileButton<S, T> extends TableCell<S, T> {
    ...
    public final Callback<TableColumn<File, String>, TableCell<File, String>> cellFactory
            = (final TableColumn<File, String> param) -> {

        final TableCell<File, String> cell = new TableCell<>() {
