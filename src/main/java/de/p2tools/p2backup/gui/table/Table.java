...
public class Table {
    public enum TABLE_ENUM {
        ...
        CHECK_BACKUP, FILE_HISTORY, BACKUP_ERROR, COPY_BACK_BACKUP
    }
    ...
    private static void initConf(TABLE_ENUM table_enum) {
        switch (table_enum) {
            case DIR_COMPARE:
                confWidth = ProgConfig.COMPARE_DIALOG_TABLE_WIDTH;
                confSort = ProgConfig.COMPARE_DIALOG_TABLE_SORT;
                confUpDown = ProgConfig.COMPARE_DIALOG_TABLE_UP_DOWN;
                confVis = ProgConfig.COMPARE_DIALOG_TABLE_VIS;
                confOrder = ProgConfig.COMPARE_DIALOG_TABLE_ORDER;
                break;
            case BLOCKED_FILE:
                confWidth = ProgConfig.BLOCKED_FILE_DIALOG_TABLE_WIDTH;
                confSort = ProgConfig.BLOCKED_FILE_DIALOG_TABLE_SORT;
                confUpDown = ProgConfig.BLOCKED_FILE_DIALOG_TABLE_UP_DOWN;
                confVis = ProgConfig.BLOCKED_FILE_DIALOG_TABLE_VIS;
                confOrder = ProgConfig.BLOCKED_FILE_DIALOG_TABLE_ORDER;
                break;
            case BACKUP_INFO:
                confWidth = ProgConfig.BACKUP_INFO_TABLE_WIDTH;
                confSort = ProgConfig.BACKUP_INFO_TABLE_SORT;
                confUpDown = ProgConfig.BACKUP_INFO_TABLE_UP_DOWN;
                confVis = ProgConfig.BACKUP_INFO_TABLE_VIS;
                confOrder = ProgConfig.BACKUP_INFO_TABLE_ORDER;
                break;
            case CHECK_BACKUP:
                confWidth = ProgConfig.CHECK_FILES_TABLE_WIDTH;
                confSort = ProgConfig.CHECK_FILES_TABLE_SORT;
                confUpDown = ProgConfig.CHECK_FILES_TABLE_UP_DOWN;
                confVis = ProgConfig.CHECK_FILES_TABLE_VIS;
                confOrder = ProgConfig.CHECK_FILES_TABLE_ORDER;
                break;
            case SHOW_BACKUP_FILES:
                confWidth = ProgConfig.BACKUP_FILES_TABLE_WIDTH;
                confSort = ProgConfig.BACKUP_FILES_TABLE_SORT;
            ...
            case BACKUP_ERROR:
                ...
                break;
            case COPY_BACK_BACKUP:
                confWidth = ProgConfig.COPY_BACK_BACKUP_TABLE_WIDTH;
                confSort = ProgConfig.COPY_BACK_BACKUP_TABLE_SORT;
                confUpDown = ProgConfig.COPY_BACK_BACKUP_TABLE_UP_DOWN;
                confVis = ProgConfig.COPY_BACK_BACKUP_TABLE_VIS;
                confOrder = ProgConfig.COPY_BACK_BACKUP_TABLE_ORDER;
                break;
        }
    }
