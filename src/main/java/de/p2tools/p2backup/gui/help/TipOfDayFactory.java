...
package de.p2tools.p2backup.gui.help;
...
public class TipOfDayFactory {
    ...
    private static void addTips(List<P2TipOfDay> pToolTipList) {
        ...
        text += "Der Infobereich unter der Filmliste\n" +
                ...
                "werden.";
        String image = "/de/p2tools/p2backup/res/tooltips/Info.png";
        ...
        image = "/de/p2tools/p2backup/res/tooltips/ClearFilter.png";
        ...
        image = "/de/p2tools/p2backup/res/tooltips/Filter.png";
        pToolTip = new P2TipOfDay(text, image);
        pToolTipList.add(pToolTip);
        ...
        text += "In den Programmeinstellungen\n" +
                ...
                "(Pfad, Zieldateiname, ..)\n" +
                "vorgenommen werden.";
        image = "/de/p2tools/p2backup/res/tooltips/DownloadPath.png";
        pToolTip = new P2TipOfDay(text, image);
        pToolTipList.add(pToolTip);
        ...
        text += "In den Programmeinstellungen\n" +
                ...
                "eingestellt werden.";
        image = "/de/p2tools/p2backup/res/tooltips/Keysize.png";
        pToolTip = new P2TipOfDay(text, image);
        pToolTipList.add(pToolTip);
        ...
        text += "In den Programmeinstellungen\n" +
                ...
                "schneller.";
        image = "/de/p2tools/p2backup/res/tooltips/LoadFilmlist.png";
        pToolTip = new P2TipOfDay(text, image);
        pToolTipList.add(pToolTip);
        ...
        text += "In den Programmeinstellungen\n" +
                ...
                "geändert werden.";
        image = "/de/p2tools/p2backup/res/tooltips/Videoplayer.png";
        pToolTip = new P2TipOfDay(text, image);
        pToolTipList.add(pToolTip);
        ...
        text += "Im Menü (unter \"Hilfe\") kann\n" +
                ...
                "wie beim ersten Mal.";
        image = "/de/p2tools/p2backup/res/tooltips/Reset.png";
        pToolTip = new P2TipOfDay(text, image);
        pToolTipList.add(pToolTip);
    }
}